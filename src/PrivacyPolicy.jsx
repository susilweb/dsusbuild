        ...
        <div className="container">
            <div className="row">
                <div className="col-md-12 custom00004">
                  ...
                  <p>This Privacy Policy belongs to the Terms of Service of <NavLink to="/">Dynamics Square</NavLink> and should be followed as a part of it. Your Privacy is our priority and responsibility what we always remain committed to. This Privacy Policy comprises how we protect your data and what sort of measuring tools we adopt just to ensure confidentiality and integrity for all the personal or non-personal data that you entrust to us. This Privacy Policy consists of how we collect, use, and distribute your data that imbibes your identity or personal information as well as how we manage the security and protection part of your confidential data.</p>
