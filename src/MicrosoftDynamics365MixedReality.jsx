              ...
              <div className="finace-acc">
                <div className="accordion" id="accnew">
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                       <p>Manage all your complicated tasks instantly and efficiently by simply bridging the gap between real-world and digital world objects with <NavLink to="/products/microsoft-dynamics-365/">Microsoft Dynamics 365</NavLink> Layout. Share your ideas, visions, or concepts with your team or stakeholders and edit the layouts like a real-world experience to support improved decision-making prior to implementation.</p>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="why-solution-wrapper-inner">
                      ...
                      <div className="overlay">
                        <p>
                          ...
                          vulnerabilities, and ensure <NavLink to="/products/microsoft-azure/">Azure</NavLink> backup.
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <section className="blogs-extra">
        <div className="container">
          <header className="section-header">
            ...
            <p>Whether you are a start-up, an SMB, or an enterprise, the <NavLink to="/blog/">Dynamics Square blog</NavLink> is the best place to get inspired and learn more about Microsoft Business Applications.</p>
          </header>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      To know more about contact <NavLink to="/contact-us/">Dynamics Square Team</NavLink>, we can
                      help.
                    </div>
                  </div>
                </div>
                ...
                <div className="accordion-item">
                  ...
                  >
                    <div className="accordion-body">
                      ...
                      <br />
                      <br />
                      When integrated with <NavLink to="/products/microsoft-dynamics-365-field-service/">Dynamics 365 Field Service</NavLink>, it can
                      help businesses to capture the asset information. If there
                      is a piece of critical or complex information, can be
                      transformed into easy visualization by integrating with <NavLink to="/products/microsoft-power-bi/">Power BI</NavLink> or any other enterprise-level application.
                    </div>
                  </div>
                </div>
                <div className="accordion-item">
