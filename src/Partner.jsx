    ...
    <>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-6 align-self-center">
              ...
              <div className="custom002">
                ...
                <ExternalLink href="https://www.dmsiworks.com/" target="_blank">
               www.dmsiworks.com
                </ExternalLink>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="side-heading">
              ...
              <div className="custom002">
                ...
                <ExternalLink href="https://www.anveonav.com/en/" target="_blank">
                www.anveonav.com
                </ExternalLink>
              </div>
            </div>
      ...
      <section className="busine_service_bottom custom0002">
        <div className="container">
          <div className="row g-5">
            <div className="col-lg-3 align-self-center">
              <img src="/assets/img/p3.jpg" alt="p3" />
            </div>
            <div className="col-lg-1 align-self-center"></div>
            ...
            <div className="side-heading">
              ...
              <div className="custom002">
                ...
                <ExternalLink href="http://www.to-increase.com/" target="_blank">
                www.to-increase.com
                </ExternalLink>
              </div>
            </div>
        ...
        <div className="container">
          ...
          <div className="side-heading">
              ...
              <div className="custom002">
                ...
                <ExternalLink href="http://en.agilesworkflow.com/" target="_blank">
            ...
            <div className="col-lg-1 align-self-center"></div>
            <div className="col-lg-3 align-self-center">
              <img src="/assets/img/p2.jpg" alt="p2" />
            </div>
      ...
      <section className="busine_service_bottom custom0002">
        <div className="container">
          <div className="row g-5">
            <div className="col-lg-3 align-self-center">
              <img src="/assets/img/new1.jpg" alt="new1" />
            </div>
            <div className="col-lg-1 align-self-center"></div>
            <div className="col-lg-8 align-self-center">
            <div className="side-heading">
              ...
              <div className="custom002">
                ...
                <ExternalLink href="https://e-consolutions.com/" target="_blank">
