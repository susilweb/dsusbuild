                ...
                <div className="accordion" id="accnew">
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/scalability.svg"
                            alt="scalability"
                          />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/predictibility.svg"
                            alt="predictibility"
                          />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/real-time-analysis.svg"
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img src="/assets/img/agility.svg" alt="agility" />
                        </div>
                        <span>Agility</span>
                      </button>
                    </h3>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/accesibility.svg"
                            alt="accesibility"
                          />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in">
                          <img
                            src="/assets/img/lowered-cost.svg"
                            alt="lowered-cost"
                          />
                        </div>
