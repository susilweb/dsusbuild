  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route
          exact
          path="/case-studies/dmic/"
          component={CaseStudyDmic}
        />
        <Route exact path="/case-studies/thelandlcompany/" component={CaseStudyTheLand} />
        <Route exact path="/case-studies/spectra/" component={CaseStudySpectra} />
        <Route
          exact
          path="/case-studies/shimco/"
          component={CaseStudyShimco}
        />
