...
<meta name="description" content="Ebook Ultimate Guide to Choose the Right ERP For Your Business Learn More +"/>
        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6 mobile-1 align-self-center">
              <h1>EBook</h1>
              <p>Ultimate Guide to Choose the Right ERP For Your Business</p>
              {/* <div>
