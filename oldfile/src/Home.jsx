        ...
        <div className="container">
          <div className="row">
            <div className="col-lg-6  align-self-center">
              ...
              <p>Simplify your end-to-end business processes and maximise outcomes with Microsoft Business Applications.</p>
              <div>
                  ...
                  <li className="list-n-wrp-size">
                    <div className="list-n-wrp">
                      <Link to="/products/microsoft-dynamics-365/">
                        <img src="/assets/img/ds-365.png" alt="Microsoft Dynamics 365 Partner" />
                      </Link>
                    </div>
                  </li>
                  <li>
          ...
          <div className="row justify-content-center">
            <div className="col-lg-8 col-md-8">
                <header className="section-header">
                  ...
                  <p>We Implement Microsoft Business Applications, so that your business can grow at scale.</p>
                </header>
            </div>
          </div>
          ...
          <div className="row gy-2">
            <div className="col-lg-4 col-md-6">
              <div className="service-box  service-box-blue">
                ...
                <p>
                Manage and drive end-to-end enterprise processes with a 360-degree view across your sales insights, automate finance practices, and drive effective customer engagement with Business Central.
                </p>
                <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-box service-box-blue">
                <div className="top">
                  ...
                  />
                  <h3>
                    Dynamics 365 <br />Finance
                  </h3>
                </div>
                <p>
                Improve your financial visibility with built-in AI-driven analytics & insights and reporting capabilities. Automate your financial practices while minimizing investment costs and global financial complexity.
                </p>
                <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="service-box service-box-blue">
                <div className="top">
                  ...
                  />
                  <h3>
                    Dynamics 365 <br />Supply Chain
                  </h3>
                </div>
                <p>
                Automate your supply chain practices and drive smoother flow across your operational unit with real-time efficiency all through highly customized and integrated Dynamics 365 Supply Chain Solutions.
                </p>
                <Link
            ...
            >
              <div className="service-box service-box-blue">
                ...
                <p>
                Connect your sales team, customers, and vendors with omnichannel facility to drive innovation and maximize profit. Predict & manage your sales pipeline with real-time AI insights and close deals faster.
                </p>
                <Link
            ...
            >
              <div className="service-box service-box-blue">
                <div className="top">
                  ...
                  />
                  <h3>
                    Microsoft <br />Power BI
                  </h3>
                </div>
                <p>
                Continuously monitor your overall business practices with powerful visual insights and key analytics in real-time to make improved decisions supporting your sales strategies and impacting productivity.
                </p>
            ...
            >
              <div className="service-box service-box-blue">
                ...
                <p>
                With Integrated enterprise solutions, improve and accelerate data-exchanging practices over a secured network. Seamlessly connect your devices to ensure smoother data transformation.
                </p>
                <Link
        ...
        <div className="row justify-content-center">
          <div className="col-lg-8 col-md-8">
              <header className="section-header">
                  ...
                  <p>Become an Industry leader by implementing powerful Microsoft Business Apps</p>
              </header>
          </div>
        </div>
          <div className="row gy-4">
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  <h3>Startup</h3>
                  <p>Quickly boost your business capabilities and lead your business toward a productive and efficient route through Microsoft Dynamics solutions.</p>
                  <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  <h3>Not for Profit</h3>
                  <p>Our Dynamics 365 experts can implement an efficient and highly configured solution to support your non-profit practices across your non-profit hub.</p>
                  <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  <h3>E-Commerce</h3>
                  <p>Drive unified e-commerce experience across your sales models to ensure seamless customer fulfillment, enable secure transactions, and meet demands.</p>
                  <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  <h3>Manufacturing & Distribution</h3>
                  <p>Ensure robust manufacturing and distribution practices throughout your enterprise by implementing MS Dynamics solutions for your industry.</p>
                  <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  <h3>Professional Services</h3>
                  <p>Our experienced Dynamics consultants can deploy optimal MS Dynamics solutions configured to your specific business context to maximize outcomes.</p>
                  <Link
            ...
            <div className="col-lg-4 col-md-6">
              <div className="figer-box">
                ...
                <div className="over-layer-cont">
                  <h3>Food & Beverages</h3>
                  <p>Understanding your root industrial requirements, our experts can develop a growth-hacking MS Dynamics solution for your food & beverages industry.</p>
                  <Link
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-lg-8 col-md-8">
              <header className="section-header">
                <h2>
                Microsoft Dynamics Efficiency Audit
                </h2>
                <p>Discover new business opportunities and upgrade your business capabilities to drive continuity by our Dynamics 365 system health check at no cost.</p>
              </header>
            </div>
            </div>
              ...
              <div className="content-icons-modil-1">
                <div className="content-inner-moil-1 content-inner-moil-3">
                  ...
                  <div className="cintent-right cintent-right-001">
                    <p>Evaluating your current business needs and future considerations, we drive a system check to analyze your concurrent system <NavLink to="/our-services/dynamics-365-upgrade-services/">upgrading</NavLink> needs while supporting your future potentials.</p>
                  </div>
                </div>
                <div className="content-inner-moil-1 content-inner-moil-3">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right cintent-right-001">
                    <p>Our experienced <NavLink to="/">Dynamics 365 consultants</NavLink> can diagnose your system to identify your actual system upgrading needs and suggest you the best possible solution suited to your customized business needs.</p>
                  </div>
                </div>
                <div className="content-inner-moil-1 content-inner-moil-3">
                  <div className="icons-left">
                  ...
                  <div className="cintent-right cintent-right-001">
                    <p>After performing system analysis, decision be yours whether you want to go ahead with new system configurations or would love to stay with your existing one. Further, you can schedule <NavLink to="/products/microsoft-dynamics-365/">Microsoft Dynamics 365</NavLink> Demo to upgrade your system capabilities.</p>
                  </div>
                </div>
              </div>
              <br />
                      ...
                      <div className="swiper-slide">
                        <div className="testimonial-item">
                          <div className="profile">
                            ...
                            <p>We selected them because their communication is excellent, their response times are outstanding, and their ability to solve our problems through various development projects has helped us leverage our ERP in a way that would have taken us much longer and with much greater expense. In my opinion I would rank them as a 5 out of 5.</p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
                      ...
                      <div className="swiper-slide">
                        <div className="testimonial-item">
                          <div className="profile">
                            ...
                            <p>The team at Dynamics Square are very dedicated, flexible, and attentive and will take care of all your IT needs in a very efficient and timely manner. Highly recommended!</p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
                      ...
                      <div className="swiper-slide">
                        <div className="testimonial-item">
                          <div className="profile">
                            ...
                            <p>We probed three MS Dynamic Partners, and one of the key factors in making our decision to go ahead with Dynamics Square was the outstanding customer service experience.</p>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
