...
<meta name="description" content="Contact Dynamics Square experts for Dynamics 365 CRM/ERP implementation, Support and Upgrade benefits. Book a free online consultation to know more."/>
<meta name="robots" content="follow, index, max-snippet:-1, max-video-preview:-1, max-image-preview:large"/>
<link rel="canonical" href="https://www.dynamicssquare.com/contact-us/" />
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-6 justify-self-center">
                <h1>Contact Us</h1>
                <p>
                Our Microsoft consultants are here to provide dedicated support, training and consultancy
                </p>
              </div>
        ...
        <section className="cont-into">
          ...
          <div className="row justify-content-center">
                      <div className="col-lg-8 col-md-8">
                        ...
                        <h2> Book A Slot!</h2>
                        <p><b>Have Questions About Microsoft Dynamics Products Or Services?</b><br/>Schedule a demo with our Microsoft Dynamics experts to resolve all your queries.</p>
                        </header>
                    </div>
              </div>
             ...
             <div className="col-lg-9">
              ...
              <div className="col-lg-6 col-sm-12">
                <div className="addre-left">
                  ...
                  <ExternalLink href="https://goo.gl/maps/ij2svGJ1tEPqGPvQ8" target="_blank">Locate Us on Google</ExternalLink>
                </div>
              </div>
              <div className="col-lg-6 col-sm-12">
