        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-lg-6 align-self-center">
              <img src="/assets/img/bcvsfinance.png" alt="bcvsfinance" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="col-lg-12">
              <header className="section-header">
                ...
                <p>
                  ...
                  <NavLink to="/products/microsoft-dynamics-crm/">CRM</NavLink>,{" "}
                  <NavLink to="/products/microsoft-power-bi/">Power BI</NavLink>{" "}
                  and{" "}
                  <NavLink to="/products/microsoft-dynamics-erp/">ERP</NavLink>.
      ...
      <section>
        <div className="container">
          <div className="row gx-5">
                ...
                <div className="accordion" id="accnew">
                    ...
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in wr-in-001">
                          <img src="/assets/img/icons-001.svg" alt="ic-1" />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in wr-in-001">
                          <img src="/assets/img/icons-002.svg" alt="ic-2" />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in wr-in-001">
                          <img src="/assets/img/icons-003.svg" alt="ic-3" />
                        </div>
                  ...
                  <div className="accordion-item">
                    <h3 className="accordion-header" id="headingTwo">
                      ...
                      >
                        <div className="wr-in wr-in-001">
                          <img src="/assets/img/icons-004.svg" alt="ic-4" />
                        </div>
                        <span>Wrap Up:</span>
                      </button>
                    </h3>
            ...
            <div className="col-lg-6 align-self-center">
              <img
                src="/assets/img/Tablet_Pro_Mockup_10_.png"
