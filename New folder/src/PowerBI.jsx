          ...
          <div className="row justify-content-center">
            ...
            <div className="col-lg-6 col-md-6 align-self-center">
              <div className="all-to-power-bi-content">
                ...
                <p>Our exhaustive Power BI Guide helps you to make informed decisions.</p>
                <div className="button-call-ac">
                  <NavLink to="/guides/power-bi-guide-for-smb/" className="bt-red bt-red-a">Read It Now</NavLink>
                  <NavLink to="/" className="bt-red-border bt-red-a">Download as PDF</NavLink>
                </div>
              </div>
            </div>
            <div className="col-lg-6 col-md-6">
              ...
              <img
                src="/assets/img/mask-group@3x.png"
                alt="mask-group@3x"
              />
              </div>
            </div>
